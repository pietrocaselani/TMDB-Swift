...
Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/pietrocaselani/TMDB-Swift'
  s.license          = { :type => 'UNLICENSE', :file => 'UNLICENSE' }
  s.author           = { 'Pietro Caselani' => 'pc1992@gmail.com' }
  s.source           = { :git => 'https://github.com/pietrocaselani/TMDB-Swift.git', :tag => s.version.to_s }
  s.social_media_url = 'https://twitter.com/pietropc_'
  s.module_name      = 'TMDBSwift'
  s.swift_version    = '4.1'
